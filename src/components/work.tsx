...
export default function Work() {
  return (
    <section className="section-layout flex-col border border-y-1 border-gray w-screen">
      ...
      <div className="flex flex-col gap-20 mt-10 w-9/10">
        <article className="flex gap-10 items-center w-full justify-between">
          <div className="h-60 rounded-xl overflow-x-hidden border border-gray">
            <img
              src={adlerSampleImg1}
              alt=""
          ...
          <div className="w-3/5">
            ...
            <p className="w-11/12 font-sans whitespace-break-spaces">
              서비스 정식 런칭을 위해 기존에 개발한 모든 페이지에 대한 반응형
              작업을 진행했습니다. Mobile / Tablet / Laptop / PC 네 가지
              디바이스를 기준으로 작업했으며, 기기별 화면 크기와 사용자 경험을
              최적화해 다양한 환경에서도 일관된 서비스 품질을 제공할 수 있도록
              했습니다.
            </p>
          </div>
        </article>
        <article className="flex gap-10 items-center flex-row-reverse justify-between">
          <div className="h-60 rounded-xl overflow-x-hidden border border-gray">
            <img
              src={adlerSampleImg5}
              alt=""
        ...
        <article className="flex gap-10 items-center">
          ...
          <div className="w-3/5">
            <h3 className="font-black text-2xl mb-4 text-blue">
              서비스 기획 참여
            </h3>
            <p className="w-11/12 font-sans whitespace-break-spaces">
