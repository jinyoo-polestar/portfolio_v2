...
export default function Workstyle() {
  return (
    <>
      <section className="section-layout bg-gradient-to-b from-[rgba(255,255,255,0.8)] from-20% via-[rgba(143,178,232,0.5)] from-56% to-[rgba(139,198,236,0.4)] flex-col items-center relative justify-center min-h-screen">
        <h2 className="section-title mb-24 font-higilight">
          퍼블리셔로서 저는 이런 모습이예요
        </h2>
        <div className="font-sans relative w-2/3 flex flex-col gap-10 items-center">
          <article className="flex bg-white rounded-lg p-6 gap-10 items-center w-full">
            <div className="bg-bluegray inline-flex items-center justify-center  aspect-video rounded-lg">
            ...
            <div className="w-7/12">
              ...
              <p className="text-gray200 break-keep">
                모든 사용자가 제약 없이 웹에 접근할 수 있도록 세심한 디테일을
                신경 씁니다.{" "}
          ...
          <article className="flex  bg-white rounded-lg p-6 gap-10 items-center w-full">
            ...
            <div className="w-7/12">
              ...
              <p className="text-gray200 break-keep">
                ...
                중점을 둡니다. 개발자, 디자이너, 기획자와의 원활한 소통을
                바탕으로 프로젝트 목표를 효과적으로 달성하고, 결과물의 퀄리티를
                한층 높입니다.
              </p>
            </div>
          </article>
